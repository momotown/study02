...
public class SabermetricsDataTable extends DataTable {
	...
	public SabermetricsDataTable() {
		...
		cd.add(new ColumnDescription("OBP",			ValueType.TEXT,		"îÌèoó€ó¶"));
		cd.add(new ColumnDescription("SLG",			ValueType.TEXT,		"îÌí∑ë≈ó¶"));
		cd.add(new ColumnDescription("OPS",			ValueType.TEXT,		"îÌOPS"));
